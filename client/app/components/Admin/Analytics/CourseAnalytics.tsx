    ...
    <>
      {isLoading ? (
        ...
        <div className="h-full">
          ...
          <div className={`${styles.card} w-full h-[40vh] sm:h-[60vh] p-2 sm:p-6 flex items-center justify-center`}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={analyticsData} margin={{ top: 20, right: 0, left: -20, bottom: 0 }}>
                ...
                <Bar dataKey="uv" fill="#3b82f6" radius={[4, 4, 0, 0]}>
                  <LabelList dataKey="uv" position="top" fill="#888888" fontSize={10} />
                </Bar>
              </BarChart>
            </ResponsiveContainer>
          </div>
