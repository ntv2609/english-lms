...
const AllUsers: FC<Props> = ({ isTeam }) => {
  ...
  const handleUpdateRole = async () => {
    const id = data.users.find((user: any) => user.email === email)?._id;
    if (id) {
        await updateUserRole({ id: id.toString(), role });
    } else {
        ...
        <Box m="20px">
          {isTeam && (
            <div className="w-full flex justify-end">
              <div
                className={`${styles.button} !w-[220px] !h-[35px] dark:bg-[#57c7a3] dark:border dark:border-[#ffffff6c]`}
            ...
            >
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                ...
                <div className="mt-4">
                  ...
                  >
                    <option className="dark:bg-slate-900 dark:text-white text-black" value="admin">Admin</option>
